...
@Autonomous(name = "Red Goal 3 Line Barrier 2", group = "Red")
public class RedGoal3LineBarrier2 extends OpMode {
    ...
    public static class AutoPaths {
        ...
        public AutoPaths(Follower follower) {
            ...
            secondLineToBarrier = follower.pathBuilder()
                    .addPath(new BezierCurve(
                            mirroredPoint(9.929, 54.362138284021114),
                            mirroredPoint(48.065, 56.067),
                            mirroredPoint(15.230, 70.385)
                    ))
