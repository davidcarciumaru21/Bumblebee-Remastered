...
@Autonomous(name = "Blue Base 3 Line Base", group = "Blue")
public class BlueBase3LineBase extends OpMode {
    ...
    public static class AutoPaths {
        ...
        public final PathChain shootToFirstLineApproach;
        ...
        public AutoPaths(Follower follower) {
            ...
            shootToBaseApproach = follower.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(52.395950155763245, 11.985669781931465),
                            new Pose(9.186319325885822, 34.59085523515356)
                    ))
            ...
            baseIntake = follower.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(9.186319325885822, 34.59085523515356),
                            new Pose(8.084294403767442, 10.508986230125752)
                    ))
            ...
            baseToShoot = follower.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(8.084294403767442, 10.508986230125752),
                            new Pose(27.59526246668123, 28.18580152627784),
                            new Pose(52.395950155763245, 11.985669781931465)
                    ))
            ...
            shootToFirstLineApproach = follower.pathBuilder()
                    .addPath(new BezierLine(
                            new Pose(52.395950155763245, 11.985669781931465),
                            new Pose(52.178960339110226, 82.5)
                    ))
                    .setLinearHeadingInterpolation(Math.toRadians(120.0), Math.toRadians(180.0))
                    .build();
    ...
    public void start() {
        schedule(
                sequential(
                        ...
                        followWithTimeout(follower, paths.shootToFirstLineApproach, DEFAULT_PATH_TIMEOUT_MS),
                        collectLine(paths.firstLineIntake, LINE_INTAKE_POWER, LINE_INTAKE_TIMEOUT_MS),
