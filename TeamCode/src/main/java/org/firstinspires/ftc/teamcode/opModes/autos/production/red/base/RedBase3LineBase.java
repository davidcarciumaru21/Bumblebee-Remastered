...
@Autonomous(name = "Red Base 3 Line Base", group = "Red")
public class RedBase3LineBase extends OpMode {
    ...
    public static class AutoPaths {
        ...
        public AutoPaths(Follower follower) {
            ...
            shootToFirstLineApproach = follower.pathBuilder()
                    .addPath(new BezierLine(
                            mirroredPoint(52.395950155763245, 11.985669781931465),
                            mirroredPoint(52.178960339110226, 82.5)
                    ))
                    .setLinearHeadingInterpolation(mirroredHeading(120.0), mirroredHeading(180.0))
                    .build();
