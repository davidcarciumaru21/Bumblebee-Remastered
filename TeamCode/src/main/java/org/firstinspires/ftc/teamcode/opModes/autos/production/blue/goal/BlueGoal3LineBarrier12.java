...
@Autonomous(name = "Blue Goal 3 Line Barrier 12", group = "Blue")
public class BlueGoal3LineBarrier12 extends OpMode {
    ...
    public static class AutoPaths {
        ...
        public AutoPaths(Follower follower) {
            ...
            firstLineToBarrier = follower.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(21.000, 82.500),
                            new Pose(27.359, 71.718),
                            new Pose(15.865, 70.584)
                    ))
            ...
            firstBarrierToShoot = follower.pathBuilder()
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(90.0), Math.toRadians(137.0))
                    .build();
            ...
            secondLineToBarrier = follower.pathBuilder()
                    .addPath(new BezierCurve(
                            new Pose(11.929, 58.550),
                            new Pose(48.065, 56.067),
                            new Pose(17.230, 70.385)
                    ))
                    .setLinearHeadingInterpolation(Math.toRadians(180.0), Math.toRadians(90.0))
                    .build();
