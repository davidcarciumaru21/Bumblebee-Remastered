...
public class ShootingConfig {
    ...
    public static final class Goals {
        ...
        public static final Pose RED_GOAL_POSE       = new Pose(137, 134);
        public static final Pose BLUE_GOAL_POSE      = new Pose(3, 134);
        public static final Pose RED_FAR_GOAL_POSE   = new Pose(137, 134);
        public static final Pose BLUE_FAR_GOAL_POSE  = new Pose(3, 134);
    }
}
